    ...
    <section class="content">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                <h3 class="card-title"><?= $sub_title ?> | Giant Fashion</h3>
                ...
                <div class="row justify-content-center">
                    <div class="container ">
                        <div class="col align-self-center">
                            <img width="150" src="<?php echo base_url('assets/') ?>	images/logo1.png" style="margin-left: auto;margin-right: auto;display: block;">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            <div class="information-layout-item">
                                <li class="list-group-item row">
                                    ...
                                    <div class="col-md-8">: <b><?= strtoUpper($detail_transaksi2->opKirim) . " " . $detail_transaksi2->opsiLayanan ?></b> </div>
                                </li>
                            </div>
                            <li class="list-group-item row">
                                    ...
                                    <!-- <li class="list-group-item row">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="status_pesanan">
                                                ...
                                                <option <?= $pesanan->status_pesanan == '6' ? 'selected=selected' : ''; ?> value="6">Pesanan DiTerima</option>
                ...
                <div class="table-responsive">
                    ...
                    <?php endif ?>
                    <a href="<?= base_url('admin/') . $controller . '/print/' . $no_pesanan ?>"><button type="button" style="margin-bottom: 10px;" class="btn btn-primary">Print</button></a> -->
                    </form>
                        ...
                        <tbody>
                            ...
                            foreach ($detail_pesanan as $dp) : ?>
                                <tr>
                                    ...
                                    <td>Rp.<?= number_format($dp->ongkir, 0, ',', ',') ?></td>
